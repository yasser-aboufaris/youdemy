...
<body class="bg-gray-50">
  ...
  <div class="fixed inset-y-0 left-0 w-72 bg-white shadow-lg">
    <!-- Logo Section -->
    <div class="p-6">
      <h1 class="text-2xl font-bold text-purple-700">YourDemy</h1>
    </div>

    <!-- Navigation -->
    <nav class="mt-6 px-3">
      <!-- Dashboard -->
      <a href="#" class="flex items-center space-x-3 px-4 py-3 mb-2 rounded-lg text-gray-600 hover:bg-purple-50 hover:text-purple-700 transition-colors">
      ...
      <!-- Categories (Active) -->
      <a href="#" class="flex items-center space-x-3 px-4 py-3 mb-2 rounded-lg bg-purple-50 text-purple-700">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
