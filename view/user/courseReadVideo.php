    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-64 bg-white shadow-md p-6 flex flex-col">
            ...
            <div class="mt-auto w-full">
                <a href="signup_course.php?course_id=<?php echo $id_course; ?>" class="w-full block text-center bg-gradient-to-r from-red-600 to-red-800 text-white py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition duration-300 ease-in-out">
                    <i class="fas fa-play-circle mr-2"></i>Get Course
                </a>
            </div>
        </div>
