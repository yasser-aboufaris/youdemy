...
<div class="bg-white shadow-lg rounded-lg p-6 max-w-sm w-full border-t-4 border-violet-500">
    <!-- Heading -->
    <h2 class="text-3xl font-bold text-violet-700 text-center mb-4">Sign Up</h2>
    <p class="text-gray-500 text-center mb-6">Join us and get started!</p>

    <!-- Form -->
    <form action="../../includs/commun/signUpMethode.php" method="POST" class="space-y-4">
    <!-- Full Name -->
    <div>
        <label for="name" class="block text-sm font-medium text-violet-700">Full Name</label>
    ...
    <!-- Confirm Password -->
    <div>
        <label for="confirm-password" class="block text-sm font-medium text-violet-700">Confirm Password</label>
    ...
    <a href="#" class="text-violet-600 font-semibold hover:underline">Log in</a>
    </p>
</div>
</body>
</html>